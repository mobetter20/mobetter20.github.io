#!/usr/bin/env python3
"""Card-IA board (D32 round). The owner's flag: the card now has three views
...
<title>Metro Match &middot; card-IA board (D32)</title>
...
<style>{board_css}</style>
  ...
  <div class="iahead">
    <h1>METRO <em>MATCH</em> &middot; CARD-IA BOARD (D32)</h1>
