...
(`<slug>-diagram.svg`, Guangzhou `.png`). `build_metro_cards.py` is registered in the local `publish.sh` (untracked, main checkout; verified 2026-06-12; the network-touching geometry refresh stays out by design).
